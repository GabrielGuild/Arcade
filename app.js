...
let gameState = {
    ...
    highscores: [50000,40000,30000,20000,10000,9000,8000,7000,6000,
                 5000,4000,3000,2000,1000,900,800,700,600,500,400],
    ...
    loseCheck(){
        ...
        if (this.snake[0].x >= this.xAxis || this.snake[0].y >= this.yAxis){
    ...
    reset(){
        ...
        if(this.score > this.highscores[i]){
            this.highscores = this.score
            this.highscoreNames[i] = this.playerName
            break;
        }
        let score = document.querySelector('.score');
